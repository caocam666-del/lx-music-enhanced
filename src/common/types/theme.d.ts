declare namespace LX {
  ...
  interface Theme {
    ...
    config: {
      ...
      extInfo: Record<string, string | undefined> & {
        ...
        // Luminous Harmonic 玻璃拟态与流光背景 token
        '--glass-surface'?: string
        '--glass-surface-strong'?: string
        '--glass-surface-weak'?: string
        '--glass-card'?: string
        '--glass-card-hover'?: string
        '--glass-stroke'?: string
        '--glass-stroke-strong'?: string
        '--glass-shadow'?: string
        '--glass-blur'?: string
        '--glass-blur-strong'?: string
        '--glass-blur-card'?: string
        '--luminous-bg-base'?: string
        '--luminous-blob-opacity'?: string
        '--luminous-blob-1'?: string
        '--luminous-blob-2'?: string
        '--luminous-blob-3'?: string
