const modules = {
  ...
  winMain: {
    ...
    get_data: 'get_data',
    save_data: 'save_data',
    get_netease_cookie: 'get_netease_cookie',
    set_netease_cookie: 'set_netease_cookie',
    clear_netease_cookie: 'clear_netease_cookie',
    // Luminous Harmonic: 汽水音乐（仅歌单导入：扫码登录 + 歌单拉取）
    qishui_status: 'qishui_status',
    qishui_qr_create: 'qishui_qr_create',
    qishui_qr_check: 'qishui_qr_check',
    qishui_qr_clear: 'qishui_qr_clear',
    qishui_get_library: 'qishui_get_library',
    qishui_get_playlist_tracks: 'qishui_get_playlist_tracks',
    // Luminous Harmonic: 酷狗/QQ 音乐歌单导入
    kugou_status: 'kugou_status',
    kugou_set_cookie: 'kugou_set_cookie',
    kugou_clear_cookie: 'kugou_clear_cookie',
    kugou_get_library: 'kugou_get_library',
    kugou_get_playlist_tracks: 'kugou_get_playlist_tracks',
    kugou_open_login_window: 'kugou_open_login_window',
    qq_status: 'qq_status',
    qq_set_cookie: 'qq_set_cookie',
    qq_clear_cookie: 'qq_clear_cookie',
    qq_get_library: 'qq_get_library',
    qq_get_playlist_tracks: 'qq_get_playlist_tracks',
    qq_open_login_window: 'qq_open_login_window',
    we_list: 'we_list',
    get_project_temp_path: 'get_project_temp_path',
  ...
  winLyric: {
    ...
    set_taskbar_menu_visible: 'set_taskbar_menu_visible',
  },
  hotKey: {
    enable: 'enable',
    status: 'status',
