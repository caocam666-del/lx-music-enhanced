<template>
  <!-- Luminous Harmonic: 传 placeholder 走 i18n (组件默认值是硬编码英文) -->
  <material-search-input v-model="searchText" :placeholder="$t('search__welcome')" :list="tipList" :visible-list="visibleList" @event="handleEvent" />
</template>
