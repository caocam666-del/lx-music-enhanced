...
.list {
  ...
  backdrop-filter: blur(var(--glass-blur, 24px)) saturate(1.3);
  box-shadow: var(--glass-shadow, 0 1px 8px 0 rgba(0,0,0,.2)), inset 0 0 0 1px var(--glass-stroke, transparent);
  z-index: 10;
  overflow: hidden;
