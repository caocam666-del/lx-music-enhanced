...
.popup {
  ...
  box-shadow: var(--glass-shadow, 0 8px 32px rgba(0,0,0,.12));
  opacity: 0;
  transform: scale(.8);
  ...
  &:before {
    ...
    border-bottom: 8px solid var(--glass-stroke, transparent);
  }
  ...
  &.top {
    ...
    &:before {
      top: 100%;
      border-bottom: none;
      border-top: 8px solid var(--glass-stroke, transparent);
    }
  }
}
.list {
