...
.btns {
  ...
  max-height: min(100vh, 96px);
  overflow: auto;
  border: 1px solid var(--color-primary-alpha-300, rgb(255 255 255 / .22));
  border-radius: 10px;
  background-color: color-mix(in srgb, var(--color-content-background) 82%, transparent);
  -webkit-backdrop-filter: blur(16px) saturate(1.2);
  backdrop-filter: blur(16px) saturate(1.2);
  box-shadow: 0 8px 24px var(--color-primary-alpha-900, rgb(0 0 0 / .24));
